...
def animar():
    ...
    sem = semaforo.Sem(80, 40, 0, 0)
    sem2 = semaforo.Sem(75, 35, 1, 0)
    sem3 = semaforo.Sem(75, 40, 2, 0)
    sem4 = semaforo.Sem(80, 35, 3, 0)

    semaforos = [sem, sem2, sem3, sem4]
    sema0 = contSem.ContSem(0, "que te", semaforos)

    sem = semaforo.Sem(80, 115, 10, 0)
    sem2 = semaforo.Sem(75, 110, 11, 0)
    sem3 = semaforo.Sem(75, 115, 12, 0)
    sem4 = semaforo.Sem(80, 110, 13, 0)

    semaforos = [sem, sem2, sem3, sem4]
    sema1 = contSem.ContSem(1, "que te", semaforos)

    sem = semaforo.Sem(175, 115, 20, 0)
    sem2 = semaforo.Sem(170, 110, 21, 0)
    sem3 = semaforo.Sem(170, 115, 22, 0)
    sem4 = semaforo.Sem(175, 110, 23, 0)
